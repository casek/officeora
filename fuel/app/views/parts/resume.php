            ...
            <div class="section-content">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2 text-center">
                        <h2 class="section-title uppercase">レジュメ</h2>
                        ...
                        <div class="panel-group resume" id="work">
                            <div class="resume-item">
                                <div class="resume-year">
                                    <span class="resume-year">2001 - 現在</span>
                                </div>
                                <!-- //.resume-year -->
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4 class="resume-title">個人事業「オフィスORA」運営 第2期</h4>
                                        </div>
                                        <!-- //.panel-title -->
                                    </div>
                                    <!-- //.panel-heading -->
                                    ...
                                    <div id="work1" class="panel-collapse collapse in">
                                        <div class="panel-body text-grey">
                                            <p>
                                                中小企業向けに、ITコンサルティング・プロジェクトマネージメント・システム設計・システム開発を業務委託<br>
                            ...
                            <div class="resume-item">
                                <div class="resume-year">
                                    <span class="resume-year">1998 - 2000</span>
                                </div>
                                <!-- //.resume-year -->
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4 class="resume-title">シニアソフトウェアエンジニア - People Network Inc.</h4>
                                        </div>
                                        <!-- //.panel-title -->
                                    </div>
                                    <!-- //.panel-heading -->
                                    ...
                                    <div id="work2" class="panel-collapse collapse">
                                        <div class="panel-body text-grey">
                                            <p>
                                                アメリカ・シリコンバレーのスタートアップ企業に参加。<br>
                                                ネットワーク管理システムの設計・開発を担当。<br>
                            ...
                            <div class="resume-item">
                                <div class="resume-year">
                                    <span class="resume-year">1995 - 1997</span>
                                </div>
                                <!-- //.resume-year -->
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4 class="resume-title">個人事業「オフィスORA」運営 第1期</h4>
                                        </div>
                                        <!-- //.panel-title -->
                                    </div>
                                    <!-- //.panel-heading -->
                                    ...
                                    <div id="work3" class="panel-collapse collapse">
                                        <div class="panel-body text-grey">
                                            <p>
                                                主に業務委託でMicrosoft社のマルチメディアコンテンツ開発プロジェクトに参加。<br>
                            ...
                            <div class="resume-item">
                                <div class="resume-year">
                                    <span class="resume-year">1990 - 1995</span>
                                </div>
                                <!-- //.resume-year -->
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4 class="resume-title">ソフトウェアエンジニア - 株式会社リコー</h4>
                                        </div>
                                        <!-- //.panel-title -->
                                    </div>
                                    <!-- //.panel-heading -->
                                    ...
                                    <div id="work4" class="panel-collapse collapse">
                                        <div class="panel-body text-grey">
                                            <p>
                                                システム開発部にて、社内SEがシステム構築に使うライブラリの開発を実施。<br>
                                                主に「文字認識（OCR）」ライブラリの研究・開発を担当<br>
                ...
                <div class="row education">
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="panel-group resume" id="education">
                            <div class="resume-item">
                                <div class="resume-year">
                                    <span class="resume-year">1986 - 1990</span>
                                </div>
                                <!-- //.resume-year -->
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <div class="panel-title">
                                            <h4 class="resume-title">工学院大学 電子工学科 電子工学コース</h4>
                                        </div>
                                        <!-- //.panel-title -->
                                    </div>
                                    <!-- //.panel-heading -->
